...
output = os.path.join(location, 'kindlequotes.js')
...
def main():
    ...
    3: CleanData
    4: ExportToJs
    5: AddString: 'var quotes = '
    """
    AddString(ExportToFile(
        CleanData(ConsolidateImportantClips(OpenFileAndSplit()))))
...
def ExportToFile(content):
    with open(output, 'w', encoding='utf-8') as file:
        content.to_json(file, force_ascii=False, indent=4, orient='records')
    return content
